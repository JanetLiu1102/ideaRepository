...
public class Constant {
     ...
     * 回调host
     */
    public static final String CALLBACK_URL_HOST = "http://47.110.252.14:22";

    public static final String SERVER_URL ="http://47.110.252.14/cms-0.0.1-SNAPSHOT/project/savePro";
}
